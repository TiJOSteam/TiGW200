# TiGW200可编程4G边缘计算网关用户手册

## 产品介绍

TiGW200是钛云物联开发的支持4G Cat1网络的可编程边缘计算网关,它提供2路RS485，可通过目前的运营商4G网络将数据上报至云端,满足用户对设备的接入需求, 能够支持目前主流的网络接入协议和公有云平台，包括MQTT, COAP, LWM2M以及阿里云、腾讯云、中国移动ONENET、中国电信AEP等等。
